...
The firmware for the Caribou printers is proudly based on [Prusa Firmware](https://github.com/prusa3d/Prusa-Firmware) by Josef Prusa et al. and is distributed under the terms of the [GNU GPL 3 license](LICENSE).
