...
//Exrtuder Design R3 based printer, like Caribou, Zaribo, Bear, Bondtech extruder
...
//Extruder Design R3 based printer, like Caribou, Zaribo, Bear, Bondtech extruder
#define EXTRUDER_DESIGN_R3
